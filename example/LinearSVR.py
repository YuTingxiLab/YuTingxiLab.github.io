...
def run_training(fold):
    ...
    df_valid.loc[:, "linearSVR_pred"] = pred

    return df_valid[["id", "PHT", "kfold", "linearSVR_pred"]]
...
if __name__ == "__main__":
    ...
    fin_valid_df.to_csv("linearSVR8.csv",index=False)

end_time = time()
run_time = end_time - begin_time
print("SVM program run time:" , run_time)